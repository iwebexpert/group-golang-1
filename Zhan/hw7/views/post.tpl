...
<body>
    ...
    <div class="uk-card uk-card-default uk-card-body">
        <form post-id="{{.Id}}">
            ...
            <input type="button" value="Save" class="uk-button uk-button-default" onclick="updatePost('{{.Id}}')">
            <input type="reset" value="Reset" class="uk-button uk-button-default">
            <input type="button" value="Delete" class="uk-button uk-button-default" onclick="deletePost('{{.Id}}')">
